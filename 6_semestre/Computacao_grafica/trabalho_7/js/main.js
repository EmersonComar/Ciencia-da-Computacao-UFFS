...
ctx.fillStyle = '#ff4444'; ctx.fillRect(1, 0, 1, 1); ctx.fillRect(0, 1, 1, 1);
...
const criar_esferas = (raio, cor, pos, vel, ehLuz = false, comTextura = false) => {
...
const esferas = [
    ...
    criar_esferas(2, 0xffffff, new THREE.Vector3(0, -4, -5), new THREE.Vector3(0, 1.5, 0), false, true),
    criar_esferas(0.8, 0xFF69B4, new THREE.Vector3(-2, -3, 0), new THREE.Vector3(0.5, 0.8, 0)),
    criar_esferas(1.5, 0xffffff, new THREE.Vector3(4, 5, -3), new THREE.Vector3(-0.7, -1, 0), false, true),
...
function update() {
    esferas.forEach(e => {
        ...
        if (!e.mesh.material.type.includes("MeshBasicMaterial")) {
